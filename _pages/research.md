...
### 2022
- Jiaxuan Li & Richard Futrell. A unified information-theoretic model of EEG signatures of human language processing. Poster NeurIPS 2022 Workshop on Information-Theoretic Principles in Cognitive Systems (InfoCog), New Orleans, US, 2022. [pdf](https://github.com/goldengua/goldengua.github.io/blob/master/files/NeurIPS_2022_NoisyERP.pdf)

- Jiaxuan Li & Allyson Ettinger. A unified information-theoretic model of EEG signatures of human language processing. Poster NeurIPS 2022 Workshop on Neuro Causal and Symbolic AI (nCSI), New Orleans, US, 2022. [pdf](https://openreview.net/forum?id=sS5hCtc-uQ)
